"""
🎯 NLP Text Classification with Translation - Streamlit Version
...
# ============================================================
# 🔧 NLTK and TextBlob Data Setup (MUST BE FIRST!)
# ============================================================
import nltk
import ssl
...
def main():
    ...
    # Header
    st.markdown('<p class="main-header">🎯 NLP Text Classification with Translation</p>', unsafe_allow_html=True)
    ...
    if uploaded_file is None:
        ...
        sample_df = pd.DataFrame({
            ...
            "transcripts": [
                ...
                "Consumer: No puedo iniciar sesión | Agent: Te ayudo",
        ...
        # Output format
        st.subheader("📊 Output Format (6 Columns)")
        output_example = pd.DataFrame({
            "Conversation Id": ["CONV_001", "CONV_002"],
            "Consumer_Text": ["I can't login to my account", "No puedo iniciar sesión"],
        ...
        # Categories info
        with st.expander("📚 Supported Categories (14 Total)"):
            cols = st.columns(2)
